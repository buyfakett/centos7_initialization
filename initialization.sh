...
function install_tools(){
        if [ "${is_mainland}"x == "1"x ];then
                [ ! -f add2swap.sh ] && wget https://gitee.com/${git_project_name}/raw/master/download_file/add2swap.sh
        elif [ "${is_mainland}"x == "2"x ];then
                [ ! -f add2swap.sh ] && wget https://github.com/${git_project_name}/raw/master/download_file/add2swap.sh
        fi
}
...
EOF
        ...
        if [ "${is_mainland}"x == "1"x ];then
                [ ! -f /usr/local/bin/docker-compose ] && wget https://gitee.com/${git_project_name}/releases/download/v1.2.3/docker-compose -O /usr/local/bin/docker-compose
        elif [ "${is_mainland}"x == "2"x ];then
                [ ! -f /usr/local/bin/docker-compose ] && wget https://github.com/${git_project_name}/releases/download/v1.2.3/docker-compose -O /usr/local/bin/docker-compose
        fi
...
function install_local_nginx(){
        ...
        if [ "${is_mainland}"x == "1"x ];then
                [ ! -f /usr/local/openresty/nginx/conf/nginx.conf ] && wget https://gitee.com/${git_project_name}/raw/master/download_file/nginx_local.conf -O /usr/local/openresty/nginx/conf/nginx.conf
                [ ! -f ${local_nginx_site}/conf/conf.d/api.conf.bak ] && wget https://gitee.com/${git_project_name}/raw/master/download_file/api.conf.bak -O ${local_nginx_site}/conf/conf.d/api.conf.bak
                [ ! -f ${local_nginx_site}/conf/conf.d/reload.sh ] && wget https://gitee.com/${git_project_name}/raw/master/download_file/reload_local.sh -O ${local_nginx_site}/conf/conf.d/reload.sh
                [ ! -f ${local_nginx_site}/conf/conf.d/index.conf ] && wget https://gitee.com/${git_project_name}/raw/master/download_file/local_nginx_index.conf -O ${local_nginx_site}/conf/conf.d/index.conf
        elif [ "${is_mainland}"x == "2"x ];then
                [ ! -f /usr/local/openresty/nginx/conf/nginx.conf ] && wget https://github.com/${git_project_name}/raw/master/download_file/nginx_local.conf -O /usr/local/openresty/nginx/conf/nginx.conf
                [ ! -f ${local_nginx_site}/conf/conf.d/api.conf.bak ] && wget https://github.com/${git_project_name}/raw/master/download_file/api.conf.bak -O ${local_nginx_site}/conf/conf.d/api.conf.bak
                [ ! -f ${local_nginx_site}/conf/conf.d/reload.sh ] && wget https://github.com/${git_project_name}/raw/master/download_file/reload_local.sh -O ${local_nginx_site}/conf/conf.d/reload.sh
                [ ! -f ${local_nginx_site}/conf/conf.d/index.conf ] && wget https://github.com/${git_project_name}/raw/master/download_file/local_nginx_index.conf -O ${local_nginx_site}/conf/conf.d/index.conf
        fi
...
function install_docker_nginx(){
        ...
        if [ "${is_mainland}"x == "1"x ];then
                [ ! -f ${docker_nginx_site}/config/nginx.conf ] && wget https://gitee.com/${git_project_name}/raw/master/download_file/nginx.conf -O ${docker_nginx_site}/config/nginx.conf
        elif [ "${is_mainland}"x == "2"x ];then
                [ ! -f ${docker_nginx_site}/config/nginx.conf ] && wget https://github.com/${git_project_name}/raw/master/download_file/nginx.conf -O ${docker_nginx_site}/config/nginx.conf
        fi
...
EOF
        ...
        if [ "${is_mainland}"x == "1"x ];then
                [ ! -f ${docker_nginx_site}/config/conf.d/api.conf.bak ] && wget https://gitee.com/${git_project_name}/raw/master/download_file/api.conf.bak -O ${docker_nginx_site}/config/conf.d/api.conf.bak
                [ ! -f ${docker_nginx_site}/config/conf.d/reload.sh ] && wget https://gitee.com/${git_project_name}/raw/master/download_file/reload.sh -O ${docker_nginx_site}/config/conf.d/reload.sh
        elif [ "${is_mainland}"x == "2"x ];then
                [ ! -f ${docker_nginx_site}/config/conf.d/api.conf.bak ] && wget https://github.com/${git_project_name}/raw/master/download_file/api.conf.bak -O ${docker_nginx_site}/config/conf.d/api.conf.bak
                [ ! -f ${docker_nginx_site}/config/conf.d/reload.sh ] && wget https://github.com/${git_project_name}/raw/master/download_file/reload.sh -O ${docker_nginx_site}/config/conf.d/reload.sh
        fi
...
function install_local_maven_java17(){
        ...
        # 安装maven
        if [ "${is_mainland}"x == "1"x ];then
                [ ! -f /usr/local/apache-maven-3.6.3-bin.zip ] && wget https://gitee.com/${git_project_name}/releases/download/v1.2.3/apache-maven-3.6.3-bin.zip -O /usr/local/apache-maven-3.6.3-bin.zip
        elif [ "${is_mainland}"x == "2"x ];then
                [ ! -f usr/local/apache-maven-3.6.3-bin.zip ] && wget https://github.com/${git_project_name}/releases/download/v1.2.3/apache-maven-3.6.3-bin.zip -O /usr/local/apache-maven-3.6.3-bin.zip
        fi
        ...
        if [ "${is_mainland}"x == "1"x ];then
                [ ! -f /usr/local/maven/conf/settings.xml ] && wget https://gitee.com/${git_project_name}/releases/download/v1.2.3/settings.xml -O /usr/local/maven/conf/settings.xml
        elif [ "${is_mainland}"x == "2"x ];then
                [ ! -f /usr/local/maven/conf/settings.xml ] && wget https://github.com/${git_project_name}/releases/download/v1.2.3/settings.xml -O /usr/local/maven/conf/settings.xml
        fi

        # 安装java17
        [ ! -f /usr/local/jdk-17_linux-x64_bin.tar.gz ] && wget https://download.oracle.com/java/17/latest/jdk-17_linux-x64_bin.tar.gz -O /usr/local/jdk-17_linux-x64_bin.tar.gz
...
function install_nodejs(){
        ...
        if [ $install_node_version == 10 ];then
                if [ "${is_mainland}"x == "1"x ];then
                        [ ! -f /usr/local/nodejs/node-v10.23.0-linux-x64.tar.xz ] && wget https://gitee.com/${git_project_name}/releases/download/v1.2.3/node-v10.23.0-linux-x64.tar.xz -O /usr/local/nodejs/node-v10.23.0-linux-x64.tar.xz
                elif [ "${is_mainland}"x == "2"x ];then
                        [ ! -f /usr/local/nodejs/node-v10.23.0-linux-x64.tar.xz ] && wget https://github.com/${git_project_name}/releases/download/v1.2.3/node-v10.23.0-linux-x64.tar.xz -O /usr/local/nodejs/node-v10.23.0-linux-x64.tar.xz
                fi
        ...
        if [ $install_node_version == 12 ];then
                if [ "${is_mainland}"x == "1"x ];then
                        [ ! -f /usr/local/nodejs/node-v12.4.0-linux-x64.tar.xz ] && wget https://gitee.com/${git_project_name}/releases/download/v1.2.3/node-v12.4.0-linux-x64.tar.xz -O /usr/local/nodejs/node-v12.4.0-linux-x64.tar.xz
                elif [ "${is_mainland}"x == "2"x ];then
                        [ ! -f /usr/local/nodejs/node-v12.4.0-linux-x64.tar.xz ] && wget https://github.com/${git_project_name}/releases/download/v1.2.3/node-v12.4.0-linux-x64.tar.xz -O /usr/local/nodejs/node-v12.4.0-linux-x64.tar.xz
                fi
        ...
        if [ $install_node_version == 14 ];then
                if [ "${is_mainland}"x == "1"x ];then
                        [ ! -f /usr/local/nodejs/node-v14.17.1-linux-x64.tar.xz ] && wget https://gitee.com/${git_project_name}/releases/download/v1.2.3/node-v14.17.1-linux-x64.tar.xz -O /usr/local/nodejs/node-v14.17.1-linux-x64.tar.xz
                elif [ "${is_mainland}"x == "2"x ];then
                        [ ! -f /usr/local/nodejs/node-v14.17.1-linux-x64.tar.xz ] && wget https://github.com/${git_project_name}/releases/download/v1.2.3/node-v14.17.1-linux-x64.tar.xz -O /usr/local/nodejs/node-v14.17.1-linux-x64.tar.xz
                fi
        ...
        if [ $install_node_version == 16 ];then
                if [ "${is_mainland}"x == "1"x ];then
                        [ ! -f /usr/local/nodejs/node-v16.20.2-linux-x64.tar.xz ] && wget https://gitee.com/${git_project_name}/releases/download/v1.2.3/node-v16.20.2-linux-x64.tar.xz -O /usr/local/nodejs/node-v16.20.2-linux-x64.tar.xz
                elif [ "${is_mainland}"x == "2"x ];then
                        [ ! -f /usr/local/nodejs/node-v16.20.2-linux-x64.tar.xz ] && wget https://github.com/${git_project_name}/releases/download/v1.2.3/node-v16.20.2-linux-x64.tar.xz -O /usr/local/nodejs/node-v16.20.2-linux-x64.tar.xz
                fi
